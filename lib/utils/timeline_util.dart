...
import 'package:nian_common_utils/utils/time_utils.dart';
...
class TimelineUtil {
  ...
  static String _getYesterday(
    ...
    return info.customYesterday() +
        (dayFormat == DayFormat.Full
            ? (" ${TimeUtils.getTime(milliseconds: timeMillis, format: DateFormat.HOUR_MINUTE) as String}")
            : "");
  }
  ...
  ///format Days.
  static String? _formatDays(int timeMillis, num days,
      TimelineInfo timelineInfo, DayFormat dayFormat) {
    String? timeline;
    switch (dayFormat) {
      ...
      case DayFormat.Common:
        timeline = TimeUtils.getTime(
            milliseconds: timeMillis, format: DateFormat.MONTH_DAY);
        break;
      case DayFormat.Full:
        timeline = TimeUtils.getTime(
            milliseconds: timeMillis, format: DateFormat.MONTH_DAY_HOUR_MINUTE);
        break;
    }
    return timeline;
  }
