...
class QueueUtils {
  ...
  /// Use map key to store multiple QueueUtils singletons, the purpose is to isolate multiple types of queue tasks without interfering with each other
  static final Map<String, QueueUtils> _instance = <String, QueueUtils>{};
...
class _TaskInfo {
  ...
  // });
  // print("加入队列-net, taskNo: 3");
  // QueueUtils.get("net")?.addTask(() {
  //   return _doFuture("net", 3);
  // });
